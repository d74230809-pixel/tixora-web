...
<html lang="en">
  ...
  <head>
    ...
    <title>Tixora Bot Dashboard</title>    
...
- Added Pings Feature configuration to Category settings.
- Updated TRPC routers to support new ping fields.
- Improved UI for Category management with better visual feedback.
